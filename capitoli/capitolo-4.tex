...
\begin{itemize}
	\item{adattabilità della rappresentazione degli eventi tramite l'\textit{output} dell'operatore \textbf{\textit{Bumblebee}} definito come \textbf{\textit{BumblebeeOuput}}, che va a definire la trasformazione degli eventi "grezzi" in eventi arricchiti da informazioni necessarie per il loro processamento;}
