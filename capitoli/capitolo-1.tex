...
\begin{risk}{Adattabilità operatore \textit{AlertCoProces}}
    \riskdescription{l'operatore preesistente non riusciva ad alzare anomalie su gruppi di risorse differenti}
...
\begin{itemize}
	...
	\item{Massimi:
		\begin{itemize}
			...
			\item{Test automatizzati dell’\textit{\gls{api}}.}
		\end{itemize}			
	}
\end{itemize}
