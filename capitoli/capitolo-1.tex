...
\begin{itemize}
	\item{Minimi:
		\begin{itemize}
			...
			\item{Definizione dell’architettura ad alto livello per la funzionalità di \textit{anomaly detection} su \textit{asset} raggruppati ed eventuali modifiche al sistema attuale;}
...
\begin{itemize}
	\item{Minimi:
		\begin{itemize}
			\item{Completamento dello sviluppo e validazione degli operatore di \textit{anomaly detection} su \textit{asset} raggruppati;}
